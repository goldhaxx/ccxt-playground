#!/usr/bin/env python3
"""
Basic example of fetching OHLCV (Open, High, Low, Close, Volume) data from Coinbase.
This script demonstrates how to:
1. Initialize the Coinbase exchange
...
def fetch_ohlcv(symbol='BTC/USD', timeframe='1h', limit=100, max_retries=3):
    """
    Fetch OHLCV data from Coinbase for a given symbol and timeframe.
        ...
        try:
            ...
            exchange = ccxt.coinbase({
                ...
                'options': {
                    ...
                    'createMarketBuyOrderRequiresPrice': True,  # Coinbase specific requirement
...
def main():
    # Example usage
    symbol = 'BTC/USD'  # Coinbase primarily uses USD pairs
    timeframe = '1h'
    limit = 100
    
    print(f"[yellow]Fetching {timeframe} OHLCV data for {symbol} from Coinbase...[/yellow]")
